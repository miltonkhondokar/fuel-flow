        ...
        <div class="card card-custom gutter-b mb-5 mb-xl-8">
            ...
            <div class="card-body">
                <form method="GET" action="{{ route('users.index') }}" class="mb-5">
                    @php
                        $filters = request()->only(['name', 'phone', 'email', 'user_type', 'user_status', 'gender']);
                    @endphp
                    <div class="row g-3">

                        <div class="col-md-3">
                            <input type="text" name="name" value="{{ $filters['name'] ?? '' }}" class="form-control" placeholder="Name">
                        </div>
                        ...
                        <div class="col-md-3">
                            <input type="email" name="email" value="{{ $filters['email'] ?? '' }}" class="form-control" placeholder="Email">
                        </div>

                        <div class="col-md-3">
                            <select name="user_type" class="form-select">
                                <option value="">User Type</option>
                                <option value="1" {{ isset($filters['user_type']) && $filters['user_type'] == 1 ? 'selected' : '' }}>User</option>
                                <option value="2" {{ isset($filters['user_type']) && $filters['user_type'] == 2 ? 'selected' : '' }}>Agent</option>
                                <option value="3" {{ isset($filters['user_type']) && $filters['user_type'] == 3 ? 'selected' : '' }}>Admin</option>
                                <option value="4" {{ isset($filters['user_type']) && $filters['user_type'] == 4 ? 'selected' : '' }}>Super Admin</option>
                            </select>
                        </div>
                        ...
                        <div class="col-md-3">
                            <select name="user_status" class="form-select">
                                ...
                                <option value="1" {{ isset($filters['user_status']) && $filters['user_status'] == 1 ? 'selected' : '' }}>Active</option>
                                <option value="0" {{ isset($filters['user_status']) && $filters['user_status'] == 0 ? 'selected' : '' }}>Inactive</option>
                            </select>
                        </div>
