<div id="kt_app_header" class="app-header" data-kt-sticky="true" data-kt-sticky-activate="{default: true, lg: true}"
    ...
    <div class="app-container container-fluid d-flex align-items-stretch justify-content-between"
        ...
        <div class="d-flex align-items-center flex-grow-1 flex-lg-grow-0">
            <a href="{{ route('/') }}" class="d-lg-none">
                <span class="h-25px app-sidebar-logo-default"
                    style="font-size: large; color:#CF392F;">{{ config('app.name') }}</span>
            </a>
        </div>
        <!--end::Mobile logo-->
            ...
            <div class="app-navbar flex-shrink-0">
                                    ...
                                    <div class="row g-2">
                                        ...
                                        <div class="col-4">
                                            <a href="#"
                                                ...
                                                <span class="fw-semibold">Create TT</span>
                                            </a>
                                        </div>
                                        <!--end::Col-->
                                    </div>
                ...
                <div class="app-navbar-item ms-1 ms-md-4" id="kt_header_user_menu_toggle">
                    ...
                    <div class="cursor-pointer symbol symbol-35px"
                        data-kt-menu-trigger="{default: 'click', lg: 'hover'}" data-kt-menu-attach="parent"
                        data-kt-menu-placement="bottom-end">
                        <img src="{{ asset('assets/media/images/farmer.jpg') }}" class="rounded-3" alt="user" />
                    </div>
                        ...
                        <div class="menu-item px-3">
                            <div class="menu-content d-flex align-items-center px-3">
                                ...
                                <div class="symbol symbol-50px me-5">
                                    <img alt="Profile Image" src="{{ asset('assets/media/images/farmer.jpg') }}" />
                                </div>
                                <!--end::Avatar-->
                                <!--begin::Username-->
                                <div class="d-flex flex-column">
                                    <div class="fw-bold d-flex align-items-center fs-5">{{ Auth::user()->name }}
                                        {{-- <span class="badge badge-light-success fw-bold fs-8 px-2 py-1 ms-2">{{ getUserRoleName() }}</span> --}}
                                    </div>
                                    <a href="#"
